...
def _system_prompt() -> str:
    return (
        ...
        "       Create ALL the field-aliasing calc steps from Step B as the\n"
        "       FIRST steps in create_saved_rule (or add_step_to_rule before\n"
        "       any calculation steps). Include:\n"
        "         • One calc step per data field (named in snake_case, no event prefix).\n"
        "         • A 'subinstrumentid' step (see NON-SCALAR rule above).\n"
        "         • postingdate/effectivedate alias steps if used downstream.\n"
        ...
        "\n"
        "     Why: agents that skip this gate inline EVENTNAME.field everywhere,\n"
        "     silently drop non-scalar rows, and produce undefined-variable loops.\n"
        "     This gate prevents ALL of those failure modes.\n"
